...
function fetchSearchResults(query, page) {
    axios.get(`http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/stores/?search=${query}&page=${page}`)
        .then(response => {
...
function fetchScrapperData() {
    axios.get('http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/scrappers/?page=1')
        .then(response => {
...
function fetchDataByCategory(category, page) {
    axios.get(`http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/stores/?page=${page}`)
        .then(response => {
