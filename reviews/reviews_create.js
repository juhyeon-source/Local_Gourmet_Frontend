...
function searchStores() {
    ...
    axios.get(`https://www.sparta-local-gourmet.store/api/stores/?search=${searchQuery}`)
        .then(response => {
...
function postReview(event) {
    ...
    axios.post('https://www.sparta-local-gourmet.store/api/reviews/create/', formData, {
        headers: {
