...
function deleteReview(reviewId) {
    const token = localStorage.getItem('access');
    axios.delete(`http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/reviews/${reviewId}/destroy/`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    })
...
function getComments(reviewId, page) {
    axios.get(`http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/reviews/${reviewId}/comments/?page_size=${page}`)
        .then(response => {
...
function deleteComment(commentId) {
    const token = localStorage.getItem('access');
    axios.delete(`http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/reviews/comments/${commentId}/destroy/`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    })
...
document.getElementById('comment-form').addEventListener('submit', function (event) {
    ...
    axios.post(`http://ec2-3-38-191-229.ap-northeast-2.compute.amazonaws.com/api/reviews/${reviewId}/comment/`, formData, {
        headers: {
            'Authorization': `Bearer ${token}`,
